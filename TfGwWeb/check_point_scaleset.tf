resource "azurerm_virtual_machine_scale_set" "chkpscaleset" {
  ...
  tags = {
          x-chkp-template = "Azure_VisualStudio_R81"
          x-chkp-management = "r81mgmt"
